...
<div class="bg-white shadow-sm rounded-lg p-6 border border-gray-100 flex flex-col justify-between h-full">
    ...
    <div class="mt-6 flex justify-end space-x-2 border-t pt-4">
        <button title="Subscribed" class="p-2 text-blue-600 hover:bg-blue-50 rounded-md transition">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
        </button>
        <button title="Show" class="p-2 text-gray-600 hover:bg-gray-50 rounded-md transition">
        ...
        <button title="Edit" class="p-2 text-yellow-600 hover:bg-yellow-50 rounded-md transition">
